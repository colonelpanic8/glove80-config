...
//! gates. Generates/checks `protocol/vectors/host-protocol-v1.4.json`.
...
fn golden_doc() -> Value {
    ...
    json!({
        ...
        "generatedBy": "protocol/glove80-host-protocol tests/golden_v14.rs (GLOVE80_WRITE_VECTORS=1 cargo test --test golden_v14)",
